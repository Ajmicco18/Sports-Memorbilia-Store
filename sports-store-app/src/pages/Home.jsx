...
export default function Home() {
    ...
    const products = [{ price: "$12.45", description: "Barry Bonds 1986 Rookie Card", imgUrl: bonds, productUrl: "/trading-cards/bonds" },
    { price: "$99.99", description: "Official Shohei Ohtani Game Jersey", imgUrl: ohtani, productUrl: "/jerseys/ohtani" },
    { price: "$20.00", description: "Anthracite Ohio State Hat", imgUrl: ohioState, productUrl: "/apparel/osu" },
    { price: "$40.00", description: "Nike Golden State Warriors Hoodie", imgUrl: warriors, productUrl: "/apparel/warriors" },
    ]
