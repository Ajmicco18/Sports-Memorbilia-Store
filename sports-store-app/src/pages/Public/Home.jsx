...
export default function Home() {
    ...
    { price: "$99.99", description: "Official Shohei Ohtani Game Jersey", imgUrl: ohtani, productUrl: "/jerseys/6" },
    { price: "$20.00", description: "Anthracite Ohio State Hat", imgUrl: ohioState, productUrl: "/apparel/10" },
    { price: "$40.00", description: "Nike Golden State Warriors Hoodie", imgUrl: warriors, productUrl: "/apparel/12" }]
